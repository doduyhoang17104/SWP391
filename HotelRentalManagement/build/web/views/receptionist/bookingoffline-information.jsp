...
<html lang="vi">
    <head>
        ...
        <style>/* General Body and Font Styles */
            body {
    ...
    <body>
        ...
        <form id="userForm" action="bookOffline" method="post" class="registration-container">
            <div class="dashboard-container">
                ...
                <main class="main-content">
                    ...
                    <div class="form-panel personal-info">
                        <div class="form-header green">Thông tin người đặt phòng</div>
                        <div class="form-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="phoneNumber" value="${phoneNumber != null ? phoneNumber : ''}" required/>
                            </div>

                            <div class="form-group">
                                <label for="address">Địa chỉ</label>
                                <textarea name="address" required>${address != null ? address : ''}</textarea>
                            </div>

                            <div class="form-group">
                                <label for="identityCard">CCCD / CMND <span>*</span></label>
                                <input type="text" name="identityCard" value="${identityCard != null ? identityCard : ''}"required />
                            </div>
