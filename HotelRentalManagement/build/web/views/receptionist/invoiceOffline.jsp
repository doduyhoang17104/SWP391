        ...
        <div class="container py-5">
            <div class="text-center mb-5">
                <h2 class="text-center text-primary fw-bold">
                    <i class="bi bi-receipt"></i> Hóa đơn đặt phòng (Offline)
                </h2>
            ...
            <div class="invoice-box">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <i class="bi bi-person"></i> Họ tên: <strong>${bookingUser.fullName}</strong>
                    </div>
                    <div class="col-md-6">
                        <i class="bi bi-telephone"></i> Số điện thoại: <strong>${bookingUser.phoneNumber}</strong>
                    </div>
                    <div class="col-md-6">
                        <i class="bi bi-credit-card"></i> CMND/CCCD: <strong>${bookingUser.identityCard}</strong>
                    </div>
                ...
                <div class="mt-4">
                    ...
                    <ul class="list-group">
                        <li class="list-group-item d-flex justify-content-between">
                            <span>Tổng tiền:</span>
                            <strong><fmt:formatNumber value="${booking.totalAmount}" type="currency" currencySymbol="₫" /></strong>
                        </li>
                        <li class="list-group-item bg-warning-subtle border-warning rounded-3 shadow-sm mt-3 p-4 d-flex justify-content-between align-items-center">
                            <div>
                                ...
                                <span class="fw-bold text-dark">Số tiền cần thanh toán trước (<span id="prepayPercent">${prepayment}</span>%):</span>
                            </div>
                        ...
                        <li class="list-group-item d-flex justify-content-between align-items-center bg-light border-0">
                            <span class="fw-semibold text-dark">Còn lại phải thanh toán sau:</span>
                            <strong class="text-danger fs-5" id="remainingAmount">
                                <fmt:formatNumber value="${booking.totalAmount - paymentAmount}" type="number" groupingUsed="true"/>đ
                            </strong>
                        </li>
                ...
                <form action="generateInvoice" method="POST" id="paymentForm">
                    ...
                    <input type="hidden" name="depositAmount" id="depositAmountInput" value="${paymentAmount}" />
                    ...
                    <!-- Chọn tiền đặt cọc -->
                    <div class="mt-4">
                        <div class="section-title"><i class="bi bi-wallet2"></i> Chọn mức thanh toán</div>
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="prepayOption" value="0.5" id="halfPayment" checked>
                            <label class="form-check-label" for="halfPayment">Thanh toán 50%</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="prepayOption" value="1.0" id="fullPayment">
                            <label class="form-check-label" for="fullPayment">Thanh toán toàn bộ</label>
                        </div>
