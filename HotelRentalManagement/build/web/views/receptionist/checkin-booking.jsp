    ...
    <body>
                ...
                <div class="container">
                    ...
                    <nav class="navbar navbar-expand-lg navbar-light bg-white py-3 mb-4 rounded shadow-sm">
                        <div class="container-fluid">
                            ...
                            <form action="checkinBooking" method="get" class="row g-3 mb-4">
                                <div class="col-auto">
                                                ...
                                                <div class="row row-cols-2 text-center g-2">
                                                    ...
                                                    <div class="col">
                                                        <div class="bg-light p-3 rounded h-100">
                                                            ...
                                                            <p class="fw-bold mb-2 text-danger">Not Checked In</p>
                                                            <form action="checkinBooking" method="post">
                                                                ...
                                                                <button class="btn btn-sm btn-success w-100">Check In</button>
                                                            </form>
                                                    ...
                                                    <div class="col">
                                                        <div class="bg-light p-3 rounded h-100">
                                                            ...
                                                            <form action="checkinBookingService" method="get">
                                                                <input type="hidden" name="bookingId" value="${b.bookingId}" />
                                                                <input type="hidden" name="roomId" value="${b.roomId}" />
                                                                <input type="hidden" name="roomNumber" value="${b.roomNumber}" />
                                                                <input type="hidden" name="checkin" value="${b.checkIn}" />
        ...
        <div class="position-fixed top-0 end-0 p-3" style="z-index:9999">
            <div id="checkinToast"
                ...
                <div class="d-flex">
                    <div class="toast-body">
                        Khách đã được check‑in thành công!
                    </div>
                    <button type="button" class="btn-close btn-close-white me-2 m-auto"
        ...
        <script>
            document.addEventListener('DOMContentLoaded', () => {
                ...
                if (params.get('checkinSuccess') === 'true') {
