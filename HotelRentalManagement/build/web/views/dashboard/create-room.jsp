                    ...
                    <form action="createRoom" method="post" enctype="multipart/form-data">
                            ...
                            <select class="form-select" id="roomTypeId" name="roomTypeId" required>
                                ...
                                <c:forEach var="type" items="${roomTypes}">
                                    <option value="${type.roomTypeId}" 
                                            <c:if test="${param.roomTypeId == type.roomTypeId}">selected</c:if>>
                                        ${type.typeName}
                                    </option>
                                </c:forEach>
                            </select>
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" id="capacity" name="capacity" required>
                                ...
                                <option value="1 người lớn" ${capacity == '1 người lớn' ? 'selected' : ''}>1 người </option>
                                <option value="2 người lớn" ${capacity == '2 người lớn' ? 'selected' : ''}>2 người </option>
                                <option value="4 người lớn" ${capacity == '4 người lớn' ? 'selected' : ''}>4 người </option>
                                <option value="6 người lớn" ${capacity == '6 người lớn' ? 'selected' : ''}>6 người </option>
                            </select>
                        </div>
