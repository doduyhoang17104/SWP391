            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Thêm loại phòng</h1>

                        <div class="card mb-4">
                            <div class="card-body">
                                Vui lòng nhập thông tin để thêm loại phòng mới vào hệ thống.
                            </div>
                        </div>
                            ...
                            <div class="card-body">
                                <form action="createRoomType" method="post">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="typeName" class="form-control" required value="${typeName != null ? typeName : ''}" />

                                    </div>
                                    <div class="mb-3">
                                        <label for="basePrice" class="form-label">Giá cơ bản (VND)</label>
                                        <input type="text" name="basePrice"  class="form-control" required 
                                               value="${basePrice != null ? basePrice : ''}" placeholder="Ví dụ: 100.000"/>

                                    </div>
                                    <div class="mb-3">
                                        <label for="description" class="form-label">Mô tả</label>
                                        <textarea name="description" rows="4" class="form-control">${description != null ? description : ''}</textarea>
                                    </div>
