    ...
    @Override
     protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (success) {
            ...
            request.setAttribute("error", "Không thể xóa loại phòng vì đang có phòng sử dụng.");
            List<RoomType> roomTypes = RoomTypeDAO.getAllRoomTypesWithRooms();
            request.setAttribute("roomTypes", roomTypes);
            request.getRequestDispatcher("views/dashboard/room-type.jsp").forward(request, response);
        }
    }
