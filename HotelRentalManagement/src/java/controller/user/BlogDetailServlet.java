...
public class BlogDetailServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        String idPostt = request.getParameter("id");
        int idPost = Integer.parseInt(idPostt);
        try {
            BlogPostDAO bp = new BlogPostDAO();
            CommentDAO cd = new CommentDAO();
            List<Comment> listComment = cd.getCommentsByPostId(idPost);
            int count = listComment.size();
            BlogPost post = bp.getPostById(idPost);
