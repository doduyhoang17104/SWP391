...
public class SearchHistoryBookingServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet SearchHistotyBookingServlet</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet SearchHistotyBookingServlet at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<Booking> listB = bd.searchBookingByUserId(uId, fromDate, toDate, roomTypes, priceFrom, priceTo);
            ...
            e.printStackTrace();
            response.sendRedirect("bookinghistory"); // fallback
        }
    }
