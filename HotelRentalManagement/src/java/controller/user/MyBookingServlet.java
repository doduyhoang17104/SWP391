...
public class MyBookingServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Booking> bookings = bd.getBookingsByUserIdWithPaging(uId, offset, pageSize);
        System.out.println("bóaodksadsad "+bookings.size());
        int totalRecords = bd.countBookingsByCustomer(uId);
        System.out.println("tổng: "+totalRecords);
        ...
        request.setAttribute("listB", bookings); // ✅ Gửi danh sách đã phân trang
