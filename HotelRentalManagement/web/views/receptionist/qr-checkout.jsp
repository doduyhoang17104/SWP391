        ...
        <div class="container py-5">
            <div class="card qr-card">
                ...
                <div class="card-body text-center">
                    ...
                    <img class="qr-img" src='https://img.vietqr.io/image/MB-0394855685-compact2.jpg?amount=${requestScope.depositRatio}&addInfo=Booking Id ${bookingId}&accountName=DO%20DUY%20HOANG' alt="QR Code"/>
                    <p class="text-muted" style="font-size: 0.9rem;">Quét mã để hoàn tất thanh toán</p>
                </div>
                <div class="qr-footer">
                    <form action="totalAmout" method="POST">
