<%-- 
    Document   : about
    Created on : May 21, 2025, 1:21:33 PM
    Author     : ddhoang
--%>
        ...
        <section>
            <div class="container">
                <h3 class="fw-bold mb-4 d-flex justify-content-between align-items-center">
                    <span class="mx-auto">Amenities and facilities</span>
                    <span style="color: #0088cc;
                          font-family: Arial, sans-serif;
                          font-size: 16px;">
                        <strong>Excellent 9.5</strong>
                    </span>
                    <h4>Most popular facilities</h4>
                    <c:forEach var="slist" items="${serviceList}">
                        <c:if test="${slist.serviceCategoryId == 28}">
                            <i class="bi bi-check-circle-fill text-success"></i>  ${slist.serviceName} &nbsp;&nbsp;
                        </c:if>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <c:forEach var="clist" items="${leftList}">
                            <h6 class="fw-bold mt-3">
                                <i class="bi bi-star me-2"></i> ${clist.serviceCategoryName}
                            </h6>
                            <ul class="list-unstyled">
                                <c:forEach var="slist" items="${serviceList}">
                                    <c:if test="${clist.serviceCategoryId == slist.serviceCategoryId}">
                                        <li class="mb-1">
                                            <i class="bi bi-check-circle-fill text-success me-2"></i> ${slist.serviceName}
                                        </li>
                                    </c:if>
                                </c:forEach>
                            </ul>
                    ...
                    <!-- Cột 2 -->
                    <div class="col-md-4">
                        <c:forEach var="clist" items="${centerList}">
                            <h6 class="fw-bold mt-3">
                                <i class="bi bi-star me-2"></i> ${clist.serviceCategoryName}
                            </h6>
                            <ul class="list-unstyled">
                    ...
                    <!-- Cột 3 -->
                    <div class="col-md-4">
                        <c:forEach var="clist" items="${rightList}">
                            <c:if test="${clist.getServiceCategoryId()!=28}">
                                <h6 class="fw-bold mt-3">
                                    <i class="bi bi-star me-2"></i> ${clist.serviceCategoryName}
                                </h6>
                            </c:if>
                            <ul class="list-unstyled">
                                <c:forEach var="slist" items="${serviceList}">
                                    <c:if test="${clist.serviceCategoryId == slist.serviceCategoryId && slist.getServiceCategoryId()!=28}">
                                        <li class="mb-1">
                                            <i class="bi bi-check-circle-fill text-success me-2"></i> ${slist.serviceName}
                                        </li>
                                    </c:if>
